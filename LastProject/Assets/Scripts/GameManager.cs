...
public class GameManager : MonoBehaviour
{
    ...
    private String[] objectives = new[]
    {
        ...
        "Put the rook back on the chess board",//11
        "Clean up the table from dining room",//12
        "Move the hoop from downstairs in your closet next to the bedroom 0/3",//13
        "Move the night stand from downstairs in your closet next to the bedroom 1/3",//14
        "Move the tennis rocket from downstairs in your closet next to the bedroom 2/3",//15
